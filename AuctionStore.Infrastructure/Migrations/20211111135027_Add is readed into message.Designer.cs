...
namespace AuctionStore.Infrastructure.Migrations
{
    ...
    [Migration("20211111135027_Add is readed into message")]
    partial class Addisreadedintomessage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuctionStore.Infrastructure.Models.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AuctionStore.Infrastructure.Models.Newsletter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<long>("LastNewsletterTimeStamp")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AuctionStore.Infrastructure.Models.NewsletterSubCategory", b =>
                {
                    ...
                    b.HasKey("NewsletterId", "SubCategoryId");

                    b.ToTable("NewsletterSubCategories");
                });
            ...
            modelBuilder.Entity("AuctionStore.Infrastructure.Models.BankAccount", b =>
                {
                    b.HasOne("AuctionStore.Infrastructure.Models.User", null)
                        .WithOne("BankAccount")
                        .HasForeignKey("AuctionStore.Infrastructure.Models.BankAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AuctionStore.Infrastructure.Models.NewsletterSubCategory", b =>
                {
                    b.HasOne("AuctionStore.Infrastructure.Models.Newsletter", null)
