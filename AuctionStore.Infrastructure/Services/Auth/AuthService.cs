...
namespace AuctionStore.Infrastructure.Services.Auth
{
    ...
    {
        public JwtUserTokensDto GenerateUserTokens(string userId, string userLogin, List<string> userRoles, List<Claim> customClaims, JwtOptions options)
        {
        ...
        private void GenerateUserTokensValidateOptions(JwtOptions options)
        {
        ...
        private SecurityToken DoGenerateToken(string JwtTokenIssuer, string secretKey, int expireInMinutes, string userId, string userLogin, List<Claim> customClaims)
        {
            var claims = new List<Claim>()
            {
        ...
        public bool ValidateToken(string token, string jwtTokenIssuer, string secretKey)
        {
        ...
        public List<Claim> GetTokenClaims(string token, string jwtTokenIssuer, string secretKey)
        {
            var tokenValidatorsParameters = GetTokenValidationParameters(jwtTokenIssuer, secretKey);
            var tokenHandler = new JwtSecurityTokenHandler();
        ...
        private SecurityKey GetSymetricSecurityKey(string secretKey)
        {
